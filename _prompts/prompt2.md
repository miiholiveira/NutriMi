...
Agora vamos criar a autenticação do sistema. O sistema deve permitir que um nutricionista crie uma conta e faça login. Use o Neon Auth que já está configurado no projeto "NutriMi".
...
- Cores predominantes azul royal e bordô, remetendo à área da saúde e nutrição
- Logo com o texto "NutriMi" crie o símbolo com as referências em anexo no topo de ambas as telas 
